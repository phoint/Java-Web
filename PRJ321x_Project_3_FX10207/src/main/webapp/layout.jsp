				...
				<div class="row align-items-center">
					...
					<div class="col-md-9">
						<div class="search-form">
							<form action="/PRJ321x_Project_3_FX10207/index.jsp" method="post">
								...
								<div class="dropdown-menu">
									<c:choose>
										<c:when test="${empty sessionScope.user.name }">
											...
											<a class="dropdown-item"
												href="${pageContext.request.contextPath}/RegisterServlet">Sign
												Up</a>
										</c:when>
										<c:otherwise>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath}/Logoff">Logout</a>
										</c:otherwise>
									</c:choose>
